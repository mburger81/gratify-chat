...
import { StreamingMedia, StreamingAudioOptions } from '@awesome-cordova-plugins/streaming-media/ngx';
...
export class GroupChatPage implements OnInit {
  ...
  setMessagesRead() {
    this.afDB.object('/accounts/' + this.authService.getUser()?.uid + '/groups/' + this.groupId + '/messagesRead/').remove()
  }
  ...
  uploadPhotoMessage(sourceType) {
    return new Promise((resolve) => {
      ...
      this.camera.getPicture(this.groupPhotoOption).then((imageData) => {
        ...
        const ref = this.afstorage.ref('/groupMessage/' + this.authService.getUser()?.uid + this.generateFilename())
